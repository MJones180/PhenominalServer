const addFundsConfirmation = require('./templates/addFundsConfirmation');
const charityAuthLink = require('./templates/charityAuthLink');
const charityCreated = require('./templates/charityCreated');
