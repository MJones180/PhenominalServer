...
type Mutation {
  ...
  updateManySpecialFundraisers(data: SpecialFundraiserUpdateManyMutationInput!, where: SpecialFundraiserWhereInput): BatchPayload!
...
input SpecialFundraiserUpdateManyMutationInput {
  description: String
  name: String
}
